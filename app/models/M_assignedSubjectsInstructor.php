...
class M_assignedSubjectsInstructor{
    ...
    public function getSubjects($code){
        $this->db->query('SELECT assignedSubjects.*, i_assignedSubjects_practical.*, i_assignedSubjects_tutorial.*, subjects.sub_code, subjects.sub_year, subjects.sub_stream, subjects.sub_credits, subjects.sub_semester
                            FROM subjects 
