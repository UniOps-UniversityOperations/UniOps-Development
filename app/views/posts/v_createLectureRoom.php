    ...
    <main>
        <div>
            ...
            <form action="<?php echo URLROOT;?>/Posts/createLectureRoom" method="post">
                ...
                <label for="LR_No_of_Chairs">No of Chairs:</label>
                ...
                <label for="LR_No_of_Tables">No of Tables:</label>
                ...
                <label for="LR_No_of_Bords">No of Bords:</label> 
                ...
                <label for="LR_No_of_Projectors">No of Projectors:</label>
