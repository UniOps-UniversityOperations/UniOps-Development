...
<div class="content">
    ...
    <form action="<?php echo URLROOT;?>/Posts/updateLectureRoom/<?php echo $data['LR_ID'];?>" method="POST">

        <!-- input feilds -->

        <label class="lable" for="LR_ID">Room ID:</label>
        <input type="text" id="LR_ID" name="LR_ID" placeholder="LR_ID" value="<?php echo $data["LR_ID"];?>" required><br>
        <span class="invalidFeedback">value = "<?php echo $data['LR_IDError'];?>"</span><br><br>

        <label class="lable" for="LR_Name">Room Name:</label>
        <input type="text" id="LR_Name" name="LR_Name" placeholder="LR_Name" value="<?php echo $data["LR_Name"];?>" required><br><br>

        <label class="lable" for="LR_Capacity">Capacity:</label>
        <input type="number" id="LR_Capacity" name="LR_Capacity" placeholder="LR_Capacity" value="<?php echo $data["LR_Capacity"];?>" required><br><br>

        <label class="lable" for="LR_Current_Avaliability">Current Avaliability:</label>
        <input type="text" id="LR_Current_Avaliability" name="LR_Current_Avaliability" placeholder="LR_Current_Avaliability" value="<?php echo $data["LR_Current_Avaliability"];?>" required><br><br>

        <label class="lable" for="LR_No_of_Chairs">No of Chairs:</label>
        <input type="number" id="LR_No_of_Chairs" name="LR_No_of_Chairs" placeholder="LR_No_of_Chairs" value="<?php  echo $data["LR_No_of_Chairs"];?>" required><br><br>

        <label class="lable" for="LR_No_of_Tables">No of Tables:</label>
        <input type="number" id="LR_No_of_Tables" name="LR_No_of_Tables" placeholder="LR_No_of_Tables" value="<?php echo $data["LR_No_of_Tables"];?>" required><br><br>

        <label class="lable" for="LR_No_of_Bords">No of Bords:</label> 
        <input type="number" id="LR_No_of_Bords" name="LR_No_of_Bords" placeholder="LR_No_of_Bords" value="<?php echo $data["LR_No_of_Bords"];?>" required><br><br>

        <label class="lable" for="LR_No_of_Projectors">No of Projectors:</label>
        <input type="number" id="LR_No_of_Projectors" name="LR_No_of_Projectors" placeholder="LR_No_of_Projectors" value="<?php echo $data["LR_No_of_Projectors"];?>" required><br><br>
